...
class Migration(SchemaMigration):
    ...
    models = {
        'testapp1.player': {
            ...
            'current_team': ('django.db.models.fields.related.ForeignKey', [], {'default': "'none'", 'to': "orm['testapp1.Team']", 'related_name': "'current_team'", 'to_field': "'name'"}),
        ...
        'testapp1.year': {
            ...
            'champion': ('django.db.models.fields.related.ForeignKey', [], {'default': "'none'", 'to': "orm['testapp1.Team']", 'related_name': "'champion'", 'to_field': "'name'"}),
            'finals_logo': ('django.db.models.fields.URLField', [], {'max_length': '200', 'unique': 'True'}),
            'finals_mvp': ('django.db.models.fields.related.ForeignKey', [], {'default': "'none'", 'to': "orm['testapp1.Player']", 'related_name': "'finals_mvp'", 'to_field': "'name'"}),
            'finals_recap': ('django.db.models.fields.TextField', [], {}),
            'highlights': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200', 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reg_mvp': ('django.db.models.fields.related.ForeignKey', [], {'default': "'none'", 'to': "orm['testapp1.Player']", 'related_name': "'reg_mvp'", 'to_field': "'name'"}),
