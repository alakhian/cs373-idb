...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.ha'
        db.add_column('testapp1_player', 'ha',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.ha'
        db.delete_column('testapp1_player', 'ha')
    ...
    models = {
        'testapp1.player': {
            ...
            'current_team': ('django.db.models.fields.related.ForeignKey', [], {'default': "'none'", 'related_name': "'current_team'", 'to': "orm['testapp1.Team']", 'to_field': "'name'"}),
            ...
            'ha': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2'}),
        ...
        'testapp1.year': {
            ...
            'champion': ('django.db.models.fields.related.ForeignKey', [], {'default': "'none'", 'related_name': "'champion'", 'to': "orm['testapp1.Team']", 'to_field': "'name'"}),
            'finals_logo': ('django.db.models.fields.URLField', [], {'max_length': '200', 'unique': 'True'}),
            'finals_mvp': ('django.db.models.fields.related.ForeignKey', [], {'default': "'none'", 'related_name': "'finals_mvp'", 'to': "orm['testapp1.Player']", 'to_field': "'name'"}),
            'finals_recap': ('django.db.models.fields.TextField', [], {}),
            'highlights': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200', 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reg_mvp': ('django.db.models.fields.related.ForeignKey', [], {'default': "'none'", 'related_name': "'reg_mvp'", 'to': "orm['testapp1.Player']", 'to_field': "'name'"}),
