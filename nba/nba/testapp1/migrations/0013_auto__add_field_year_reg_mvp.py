...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Year.reg_mvp'
        db.add_column('testapp1_year', 'reg_mvp',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='none', related_name='reg_mvp', to_field='name', to=orm['testapp1.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Year.reg_mvp'
        db.delete_column('testapp1_year', 'reg_mvp_id')
