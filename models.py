...
class Year(models.Model) :
    ...
    all_nba = models.ManyToManyField(Player, related_name='all_nba')
    all_def = models.ManyToManyField(Player, related_name='all_def')
    finals_mvp = models.ForeignKey(Player, related_name='finals_mvp')
